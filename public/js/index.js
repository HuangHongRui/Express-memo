...
/* WEBPACK VAR INJECTION */(function($) {__webpack_require__(12);               //渲染css
...
// module
exports.push([module.i, "@font-face {\n  font-family: 'iconfont';\n  /* project id 360873 */\n  src: url('//at.alicdn.com/t/font_cgjvrf1rlik9.eot');\n  src: url('//at.alicdn.com/t/font_cgjvrf1rlik9.eot?#iefix') format('embedded-opentype'), url('//at.alicdn.com/t/font_cgjvrf1rlik9.woff') format('woff'), url('//at.alicdn.com/t/font_cgjvrf1rlik9.ttf') format('truetype'), url('//at.alicdn.com/t/font_cgjvrf1rlik9.svg#iconfont') format('svg');\n}\nhtml,\nbody {\n  margin: 0;\n  height: 100%;\n}\nul,\nli {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\nbody {\n  font: 18px/1.5 'Chewy', 'Cabin', 'Arial';\n  letter-spacing: 1px;\n  overflow-x: hidden;\n}\na {\n  font-family: 'Bree Serif', serif;\n  text-decoration: none;\n  color: #fff;\n}\n#header {\n  top: 0;\n  font-size: 12px;\n  position: fixed;\n  max-height: 30px;\n  width: 100%;\n  z-index: 10;\n  opacity: 0.5;\n  align-items: center;\n  padding: 10px;\n  background-color: #ccc;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  justify-content: space-between;\n  user-select: none;\n}\n#header:hover {\n  opacity: 0.8;\n}\n#header a {\n  display: block;\n  font-size: 15px;\n}\n#header .user-area {\n  margin: 0  30px;\n  padding-right: 16px;\n  display: flex;\n}\n#header .user-area li span {\n  color: #000;\n  font-size: 20px;\n  display: block;\n  margin: 0 10px;\n}\n#header .user-area li .username {\n  cursor: default;\n  color: #6495ED;\n}\n#header .user-area li .logout {\n  margin: 0px;\n}\n#header .user-area img {\n  height: 30px;\n  border-radius: 50%;\n}\n#header .user-area img:hover {\n  line-height: 30px;\n  border-radius: 5px;\n}\n#header .icon {\n  font-family: 'iconfont';\n  font-size: 30px;\n  font-style: normal;\n  margin-left: -65px;\n  cursor: pointer;\n  color: #d81e06;\n}\n#header .icon:hover {\n  color: #1296db;\n}\n#header .add-note,\n#header .login,\n#header .logout {\n  border: 1px solid #fff;\n  border-radius: 4px;\n  padding: 2px 4px;\n  margin: 0  55px;\n  z-index: 20;\n}\n#header .add-note {\n  margin-right: 115px;\n}\n#header .user-area .login:hover,\n#header .user-area .logout:hover,\n#header .add-note:hover {\n  color: #000;\n  font-weight: bold;\n}\n#content {\n  position: relative;\n  margin: 50px 30px 0 ;\n  height: -webkit-calc(70%);\n  height: calc(70%);\n}\n.bgShow {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  width: 100%;\n  height: 100%;\n  display: block;\n}\n.bgShow {\n  background: #000 url(https://github.com/HuangHongRui/Express-memo/blob/master/src/img/1.jpeg?raw=true) repeat center center;\n  z-index: -10;\n  position: fixed;\n  background-size: cover;\n  background-attachment: scroll;\n}\n", ""]);
